      ...
      <div className="container" style={{ maxWidth: "800px" }}>
        ...
        {loadingAuth ? (
          ...
          <div style={{ textAlign: "center", padding: "48px 24px", border: "1px solid var(--border)", borderRadius: "4px" }}>
            ...
            <h3 style={{ fontFamily: "'Cormorant Garamond', serif", marginBottom: "12px" }}>Login Required</h3>
            <p style={{ fontSize: "0.9rem", color: "var(--color-sand)", marginBottom: "24px" }}>
          ...
          <div style={{ textAlign: "center", padding: "48px 24px", border: "1px solid var(--border)", borderRadius: "4px" }}>
            <div style={{ fontSize: "2.5rem", marginBottom: "16px" }}>📝</div>
            <h3 style={{ fontFamily: "'Cormorant Garamond', serif", marginBottom: "12px" }}>No Approved Events</h3>
            <p style={{ fontSize: "0.9rem", color: "var(--color-sand)", marginBottom: "24px" }}>
          ...
          <>
            {submitted ? (
              <div style={{ textAlign: "center", padding: "48px", background: "rgba(74,222,128,0.06)", border: "1px solid rgba(74,222,128,0.2)", borderRadius: "4px" }}>
                <div style={{ fontSize: "2.5rem", marginBottom: "16px" }}>✓</div>
                <h3 style={{ fontFamily: "'Cormorant Garamond', serif", marginBottom: "12px" }}>Logo Submitted!</h3>
                <span className="badge badge-gold">Pending Approval</span>
                <p style={{ marginTop: "16px", fontSize: "0.9rem", color: "var(--color-sand)" }}>
              ...
              <>
                ...
                <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: "4px", padding: "28px", marginBottom: "24px" }}>
                  <h4 style={{ fontFamily: "Inter, sans-serif", fontSize: "0.75rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--color-sand)", marginBottom: "20px" }}>
                      ...
                      {suggestions.map((s, i) => (
                        <button
                          ...
                          style={{
                            ...
                            color: "var(--color-cream)", fontSize: "0.95rem", lineHeight: 1.5,
                  ...
                  <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: "4px", padding: "28px" }}>
                    ...
                    <div style={{ marginBottom: "20px" }}>
                      ...
                      <textarea
                        ...
                        style={{ resize: "vertical", fontFamily: "'Cormorant Garamond', serif", fontSize: "1rem" }}
                      />
                    ...
                    <div style={{ marginBottom: "20px", padding: "24px", background: "#111", border: "1px solid var(--border)", borderRadius: "3px", textAlign: "center" }}>
                      <p style={{ fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--color-muted)", marginBottom: "8px" }}>Logo Preview</p>
                      <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.2rem", color: "var(--color-cream)", fontStyle: "italic", lineHeight: 1.4 }}>
                        {edited || "Your logo text will appear here"}
                      </p>
                      <div style={{ width: "40px", height: "1px", background: "var(--color-accent)", margin: "12px auto 0" }} />
                      <p style={{ fontSize: "0.6rem", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--color-sand)", marginTop: "8px" }}>LÄYRD · Calgary</p>
                    </div>
          ...
          <div>
            ...
            {approvedCount > 0 && (
              <div style={{
                ...
                <div>
                  <p style={{ fontWeight: 600, color: "#4ade80", fontSize: "0.9rem", marginBottom: "2px" }}>
                    {approvedCount} label{approvedCount > 1 ? "s" : ""} approved!
                  </p>
                  <p style={{ fontSize: "0.8rem", color: "var(--color-sand)" }}>
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                          ...
                          <span style={{ fontSize: "0.8rem", fontWeight: 700, color: meta.color, textTransform: "uppercase", letterSpacing: "0.08em" }}>
                            {meta.label}
                          </span>
                        </div>
                        <span style={{ fontSize: "0.7rem", color: "var(--color-muted)", fontFamily: "monospace" }}>{sub.id}</span>
                      </div>
                      ...
                      <div style={{ padding: "20px 24px 0" }}>
                        <div style={{
                          ...
                          <p style={{ fontSize: "0.6rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "#555", marginBottom: "8px" }}>Your Logo</p>
                          <p style={{
                          ...
                          <p style={{ fontSize: "0.58rem", letterSpacing: "0.14em", textTransform: "uppercase", color: "#77736B", marginTop: "6px" }}>LÄYRD · Calgary</p>
                        </div>
                      </div>

                      {/* Details */}
                      <div style={{ padding: "0 24px 20px", display: "flex", flexDirection: "column", gap: "8px" }}>
                        <div style={{ display: "flex", gap: "24px", flexWrap: "wrap", fontSize: "0.8rem", color: "var(--color-muted)" }}>
                        ...
                        {sub.status !== "Pending" && sub.adminNote && (
                          <div style={{
                            ...
                            <p style={{ fontSize: "0.72rem", textTransform: "uppercase", letterSpacing: "0.08em", color: meta.color, marginBottom: "4px", fontWeight: 600 }}>
                              Message from Adam
                            </p>
                            <p style={{ fontSize: "0.875rem", color: "var(--color-cream)" }}>{sub.adminNote}</p>
                          </div>
                        )}
                        ...
                        {sub.status === "Rejected" && (
                          <button
                            ...
                            className="btn btn-outline"
                            style={{ marginTop: "8px", width: "fit-content", fontSize: "0.8rem", padding: "6px 16px" }}
                          >
                        ...
                        {sub.status === "Approved" && (
                          <div style={{
                            ...
                            fontSize: "0.8rem", color: "var(--color-sand)",
                          }}>
