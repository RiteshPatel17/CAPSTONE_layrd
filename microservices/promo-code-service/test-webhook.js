...
if (process.env.ALLOW_LIVE_DB_SCRIPT !== 'true') {
  console.error('This script inserts and deletes real rows in orders/order_items against whatever database .env.local points at.');
  console.error('Set ALLOW_LIVE_DB_SCRIPT=true if you really mean to run this.');
  process.exit(1);
}
