        ...
        <div className="navbar-links">
          {NAV_LINKS.map((link) => {
            ...
            <Link
              ...
              onMouseEnter={(e) => (!isActive && (e.target.style.color = "var(--accent-primary)"))}
          ...
          {user ? (
            ...
            <Link
              ...
              style={{
                ...
                letterSpacing: "0.12em",
                textTransform: "uppercase",
                color: pathname === "/login" ? "var(--accent-primary)" : "var(--text-secondary)",
              ...
              onMouseEnter={(e) => (pathname !== "/login" && (e.currentTarget.style.color = "var(--accent-primary)"))}
              onMouseLeave={(e) => (pathname !== "/login" && (e.currentTarget.style.color = "var(--text-secondary)"))}
            >
              LOGIN
            </Link>
          )}
