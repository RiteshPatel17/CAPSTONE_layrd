...
export default function ContactPage() {
  ...
  async function submitMessage(session) {
    setSending(true);
    setError("");
    try {
    ...
    <div className="section" style={{ background: "var(--bg-main)" }}>
      <div className="container" style={{ maxWidth: "1000px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          ...
          <h1 style={{ marginBottom: "12px", fontSize: "clamp(26px, 4vw, 48px)", color: "var(--text-main)" }}>Contact Us</h1>
        ...
        <div className="responsive-grid-1-1-6" style={{ gap: "64px", alignItems: "start" }}>
          {/* Info */}
          <div>
            <h3 style={{ fontSize: "clamp(26px, 4vw, 48px)", marginBottom: "24px", color: "var(--text-main)", lineHeight: "120%" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              {[
                ...
                { Icon: ExternalLink, label: "Instagram", value: BRAND.instagram, href: `https://instagram.com/${BRAND.instagram.replace(/^@/, "")}` },
              ].map((item) => (
          ...
          <div>
            {sent ? (
              ...
              >
                ...
                <h3 style={{ fontSize: "clamp(26px, 4vw, 48px)", marginBottom: "16px", color: "var(--text-main)" }}>Message Sent!</h3>
      ...
      <AuthGateModal
        ...
        subtitle="Log in to send us a message."
      />
    </div>
  );
}
