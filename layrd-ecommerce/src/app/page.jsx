...
import HeroShapes from "../components/layout/HeroShapes.jsx";
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      >
        {/* Decorative product shots */}
        <HeroShapes />

        {/* Background pattern overlay (0.2 opacity, both themes) */}
        ...
        <div className="animate-fade-in" style={{ position: "relative", zIndex: 1 }}>
          ...
          <h1
            style={{
              fontSize: "clamp(55px, 10vw, 100px)",
              fontWeight: 500,
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <p style={{ maxWidth: "400px", margin: "0 auto", fontSize: "20px" }}>
