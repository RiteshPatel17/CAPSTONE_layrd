      ...
      <div className="container" style={{ maxWidth: "800px" }}>
        ...
        >
          ...
          <p style={{ marginBottom: "24px", fontSize: "20px" }}>
            Reach us at <a href={`mailto:${BRAND.email}`} style={{ color: "var(--color-accent)" }}>{BRAND.email}</a> or{" "}
            <a href={`tel:${BRAND.phone.replace(/\D/g, "")}`} style={{ color: "var(--color-accent)" }}>{BRAND.phone}</a>
          </p>
          <a href="/contact">
